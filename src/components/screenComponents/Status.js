...
const Status = ({ route, navigation }) => {
    ...
    return (
        <View
            ...
            <Image source={image} style={{position:'absolute', width: '100%',height: 520}}/>
            <View style={{
                position: 'absolute',
                bottom: 0,
                left: 0,
                ...
                <TextInput placeholder='send message' placeholderTextColor="white" style={{borderColor: 'white', borderRadius: 25, width: '85%', height: 50, paddingLeft: 20, borderWidth: 1, fontSize: 20, color:'white'}}/>
                <TouchableOpacity onPress={()=> navigation.goBack()}>
